    ...
    <div class="wrapper">
            ...
            function generateCalendar($month, $year) {
                ...
                while ($currentDay <= $totalDaysOfMonth) {
                    ...
                    $currentDayRel = str_pad($currentDay, 2, "0", STR_PAD_LEFT); // Add leading zeros if needed
                    $date = "$year-$month-$currentDayRel";
                    $calendar .= "<td data-date='$currentDay' data-month='$month' data-year='$year'>$currentDay</td>";
                    $currentDay++;
                    $dayOfWeek++;
                }
            ...
            echo "<button type='submit' value='Jump'>Jump to: </button>";
